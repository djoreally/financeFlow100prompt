...
export default function DashboardPage() {
  ...
  if (transactionsLoading) { 
    return (
      <DashboardLayout>
        <div className="container mx-auto space-y-6 print-hide mt-4"> {/* Added mt-4 for spacing from header */}
  ...
  return (
    <DashboardLayout> 
      <div className="container mx-auto space-y-8 print-container pt-6 pb-8"> {/* Added padding top/bottom */}
